...
public class MovimentacaoController {
    ...
    @FXML
    private ComboBox<String> comboSalaMov;

    @FXML
    private ComboBox<String> comboResponsavel;
    ...
    public void initialize() {
        ...
        comboSalaMov.setItems(FXCollections.observableArrayList(salaDAO.buscarTodosNomes()));
        comboResponsavel.setItems(FXCollections.observableArrayList(PessoaDAO.buscarTecnicos()));
